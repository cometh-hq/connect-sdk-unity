...
namespace ComethSDK.Scripts.Tools
{
	public static class Constants
	{
		...
		public const string MULTI_SEND_ABI =
		...
		public static NetworkData GetNetworkByChainID(string chainId)
		{
